...
export default function QrCodeGenerator() {
	...
	const profilePictureUrl = useMemo(() => {
		...
		// If no cached URL but we have an ID, generate it synchronously
	...
	const handleProfilePictureUpload = async (
		...
		try {
			// Upload the file using the proper profile system
	...
	const downloadQRCode = async () => {
		...
		try {
			...
			if (!svgElement) throw new Error('Could not find QR code SVG element')
		...
		>
			...
			<div className='flex justify-between items-center mb-4'>
				<h2
					...
					style={{ color: qrSettings.textColor }}
				>
					My QR Code
				</h2>
			...
			<AnimatePresence>
				{showSettings ? (
					...
					>
						{/* Settings Panel */}
						<Card
							style={{ backgroundColor: qrSettings.cardBackgroundColor }}
							className='h-full'
						>
									...
									<ScrollArea className='flex-1'>
										<TabsContent value='colors' className='space-y-4 mt-0'>
											...
											<div className='space-y-2'>
												<Label style={{ color: qrSettings.textColor }}>
													Quick Themes
												</Label>
											...
											<div className='grid grid-cols-2 gap-3'>
												...
												<div className='space-y-1'>
													...
													<Input
														...
														onChange={(e) =>
															updateQrSettings({ bgColor: e.target.value })
														}
														className='h-8'
													/>
												</div>
												...
												<div className='space-y-1'>
													...
													<Input
														...
														onChange={(e) =>
															updateQrSettings({ fgColor: e.target.value })
														}
														className='h-8'
													/>
												</div>
												...
												<div className='space-y-1 col-span-2'>
													...
													<Input
														...
														onChange={(e) =>
															updateQrSettings({ textColor: e.target.value })
														}
														className='h-8'
													/>
												</div>
											...
											<div className='space-y-3'>
												<div className='space-y-2'>
													...
													<Select
														...
														onValueChange={(value) =>
															updateQrSettings({ layoutStyle: value as any })
														}
													>
												...
												<div className='space-y-2'>
													...
													<Slider
														...
														onValueChange={(value) =>
															updateQrSettings({ qrSize: value[0] })
														}
														max={280}
														min={120}
														step={10}
												...
												<div className='space-y-2'>
													...
													<Slider
														...
														onValueChange={(value) =>
															updateQrSettings({ borderRadius: value[0] })
														}
														max={30}
														min={0}
														step={2}
												...
												<div className='space-y-2'>
													...
													<Slider
														...
														onValueChange={(value) =>
															updateQrSettings({ cardPadding: value[0] })
														}
														max={40}
														min={8}
														step={2}
											...
											<div className='space-y-3'>
												<div className='space-y-2'>
													...
													<Select
														...
														onValueChange={(value) =>
															updateQrSettings({ fontFamily: value })
														}
													>
														<SelectTrigger className='h-8'>
															<SelectValue />
												...
												<div className='space-y-2'>
													...
													<Slider
														...
														onValueChange={(value) =>
															updateQrSettings({ fontSize: value[0] })
														}
														max={20}
														min={10}
														step={1}
											...
											<div className='space-y-3'>
												<div className='flex items-center justify-between'>
													...
													<Switch
														...
														onCheckedChange={(checked) =>
															updateQrSettings({ showProfilePicture: checked })
														}
													/>
												</div>
												...
												<div className='flex items-center justify-between'>
													...
													<Switch
														...
														onCheckedChange={(checked) =>
															updateQrSettings({ showName: checked })
														}
													/>
												</div>
												...
												<div className='flex items-center justify-between'>
													...
													<Switch
														...
														onCheckedChange={(checked) =>
															updateQrSettings({ showTitle: checked })
														}
													/>
												</div>
												...
												<div className='flex items-center justify-between'>
													...
													<Switch
														...
														onCheckedChange={(checked) =>
															updateQrSettings({ showCompany: checked })
														}
													/>
												</div>
												...
												<div className='flex items-center justify-between'>
													...
													<Switch
														...
														onCheckedChange={(checked) =>
															updateQrSettings({ showContact: checked })
														}
													/>
												</div>
												...
												<div className='flex items-center justify-between'>
													...
													<Switch
														...
														onCheckedChange={(checked) =>
															updateQrSettings({ showSocials: checked })
														}
													/>
												</div>
											</div>
							...
							>
								<CardContent className='flex flex-col items-center justify-center p-0'>
											...
											>
												{isLoading ? (
													...
													<div className='w-full h-full flex items-center justify-center bg-muted'>
														<UserCircle
															style={{
																width: `${qrSettings.qrSize * 0.15}px`,
																height: `${qrSettings.qrSize * 0.15}px`,
															}}
									...
									<div
										...
										style={{ fontFamily: qrSettings.fontFamily }}
									>
